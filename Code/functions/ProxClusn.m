...
% ----------------------- Input ------------------------------
% U: data matrix. Size: d*m, here d is the feature dimension, m is the sample
%    size.
...
% weight: weight matrix. Size: d*(m*(m-1)/2) 
% ----------------------- Output ------------------------------
% P: d*m matrix
% Theta: d*(m*(m-1)/2) matrix
% fun: dual function values
